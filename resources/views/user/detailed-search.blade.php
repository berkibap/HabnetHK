            ...
            <div id="content">@include("partials.navbar")
                <div class="container-fluid">
                    <div class="d-sm-flex justify-content-between align-items-center mb-4">
                        <h3 class="text-dark mb-0">Detaylı Kullanıcı Arama</h3>
                    </div>
                      ...
                      <div class="card">
                            <div class="card-body">
                               <form style="width:20rem;">
                                   <div class="mb-3">
                                       <label for="">Arama Tipini Seçin:</label>
                                       <select name="type" id="type" class="form-control">
                                           <option value="username">Kullanıcı Adı</option>
                                           <option value="email">E posta</option>
                                           <option value="roomname">Oda adı</option>
                                           <option value="friendname">Arkadaş Adı</option>
                                           @if(\App\Models\HkPermissions::checkPermission($currentUser->rank, "see_user_ips"))<option value="ip_register">Kayıt Olunan IP Adresi</option>
                                           <option value="ip_last">Son Giriş Yapılan IP Adresi</option>
                                           @endif
                                       </select>
                                   </div>
                               </form>
